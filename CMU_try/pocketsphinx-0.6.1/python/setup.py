...
# If there is no /home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1 and friends use pkg-config
if '/home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1' == '' or '/home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1/include',
                   '/home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1/include']
    sb_libdirs = ['/home/wmlab/CMU_try/pocketsphinx-0.6.1/../sphinxbase-0.6.1/src/libsphinxbase/.libs']
